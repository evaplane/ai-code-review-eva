 ...
 * .github/generate-config.cjs是为了跨平台兼容性和项目技术栈统一，使用CJS格式是为了在Node.js中直接运行而不必处理ESM的兼容性问题。
 */
...
function buildConfig() {
  return {
    ai: {
      ...
      apiKey: process.env.AI_REVIEWER_OPENAI_KEY || 'sk-or-v1-955e0f1599cde81214701a3af109dc87d077c4424dfd44b121d45a007719c9b',
